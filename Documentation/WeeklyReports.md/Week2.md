...
- **Time:** 7:00 PM  
- **Location:** Zoom  
- **Attendees:** Yousef, Edward, Eric, Anirudh, Amr
...
- Finalized team roles based on strengths:
  ...
  - AI Developers: Anirudh, Amr, Khawaja  
- Conducted initial research:
  - Django–MongoDB integration explored by Edward  
  - Basic NLP libraries (NLTK, spaCy) reviewed by Khawaja, Amr, and Anirudh  
  - UI/UX references gathered by Yousef  
- Discussed team charter and Deliverable 1:
  - Drafted initial structure for the team manual  
  - Outlined the feasibility report
...
- Begin Sprint 1:
  - Define system architecture and backend endpoints
- Assigned Tasks:
  - Edward & Eric: Set up Django base application with MongoDB integration  
  - Yousef: Begin frontend wireframes and homepage layout  
  - Anirudh, Amr, Khawaja: Experiment with keyword extraction models (NLTK, spaCy, etc.)
- Complete Deliverable 1:
  - Finalize and submit the team manual and feasibility report

---

## ARE THERE ANY OBSTACLES / POTENTIAL OBSTACLES?

- Possible delays due to third-party API integration (e.g., Twitter API authentication requirements)
- Difficulty scheduling team meetings due to conflicting class timetables

---

## INDIVIDUAL REFLECTIONS

- **Khawaja:** This week, I focused on understanding the project requirements and aligning my role as an AI Developer with the team’s goals. I began researching NLP techniques for this project like Tf-idf and Tokenizer, particularly keyword extraction and relevance scoring, which will be central to our system. I also reviewed available Python libraries such as spaCy and NLTK to determine their suitability for integration with our Django backend. My main challenge was narrowing down the best approach for processing text from different data sources, but I now have a clearer direction for next week’s implementation work. I set up the collaboration on Github to work effectively.
