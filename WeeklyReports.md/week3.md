# Thread Title: Group # 22 Week 3

## MEETINGS WITH CLIENT
- **Date:** 11/08/25  
- **Time:** 4:00 PM  
- **Location:** Microsoft Teams  
- **Attendees:** Yousef, Eric, Khawaja, Miroslav(Sponsor), Humayun(Sponsor)
...
- Systematically completed Deliverable 1 (Feasibility report and Team manual).
- Meeting with the sponsor to clarify doubts and set expectations for both sides.
- Discussed our work process to complete Deliverable 1 and imporved the process for future deliverables.
- Began drafting basic structure of wireframes for front end.
- Began researching APIs to scrape data from X, LinkedIn and Reddit.
- Began experimenting with tokenization and a TF-IDF NLP workflow to rate the relevance of articles to the subject. 

---

## WHAT WILL WE BE DOING NEXT WEEK?

- We decided to start preparing for the next deliverable before the next weekly meeting.
- On the next meeting, we will plan out how to complete deliverable 2 and plan a draft for a review from the sponsor.
- In week 5, we will plan to have a formal meeting with the sponsor to go over our progress and next steps. 
...
- **Khawaja:** This week was highly productive and involved contributions to multiple deliverables. I completed Section 3 (Benefits) and Section 4.3 (Alternative Solution: White-Label AI Integration) of the Feasibility Report, ensuring the content was aligned with the sponsor’s needs and presented in a clear, quantifiable manner. These sections required detailed research into both tangible and intangible benefits, as well as a balanced analysis of advantages and disadvantages for the white-label AI integration approach.
In parallel, I worked on Section 4 of the Team Manual (Communication Plan and Meeting Schedule), documenting our primary communication channels, WhatsApp for day-to-day updates, Discord for ongoing discussions, and Microsoft Teams for meetings with the sponsor. I also included our fixed Friday 3 PM meetings and noted the additional ad-hoc sessions held during the week. I managed everything on GitHub by creating markdown files for team collaboration, allowing us to store and access everything in one place.
