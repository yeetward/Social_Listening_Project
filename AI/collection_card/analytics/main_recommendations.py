...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate personalized recommendations based on search history.")
    parser.add_argument("--type", type=str, default="research_topics", 
